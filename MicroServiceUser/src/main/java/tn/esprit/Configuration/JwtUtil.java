...
public class JwtUtil {
    ...
    @Value("${jwt.secret}")
    private String secretKey; // Injectée depuis application.properties
    ...
    // 🔑 Générer un token spécial pour la réinitialisation du mot de passe (10 min)
    ...
    // ✅ Vérifier si le token est valide (utilisé pour reset password)
