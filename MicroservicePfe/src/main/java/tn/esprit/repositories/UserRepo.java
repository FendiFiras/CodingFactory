...
public interface UserRepo extends JpaRepository<User,Long> {
    ...
    @Query("SELECT u FROM User u JOIN u.applications a WHERE a.idApplication = :applicationId")
    User findUserByApplicationId(@Param("applicationId") Long applicationId);
